		...
		<nav class="navbar navbar-expand-lg navbar-light bg-white rounded fixed-top rounded-0 shadow-sm">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">
                    ...
                    <span class="align-middle me-3">Afromedium Centrale</span>
                </a>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent1">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item"> @auth
                            <a href="{{ route('home') }}" class="nav-link active" aria-current="page"><i class='bx bx-home-alt me-1'></i>Home</a>
                        @else
                            <a href="{{ route('login') }}" class="nav-link"><i class='bx bx-home-alt me-1'></i>Log in</a>
