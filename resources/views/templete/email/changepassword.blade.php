<DOCTYPE html>
    ...
    <body style="background-color: #f3f5f7; margin: 0 !important; padding: 0 !important;">
        ...
        <div
            ...
            Your Password was updated on {{ config('app.name', 'Pittige-Dates') }}, We Will be in tuch, Please check your login
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top"
                                ...
                                <h1 style="font-size: 42px; font-weight: 400; margin: 0;"> Your Password was updated on {{ config('app.name', 'Pittige-Dates') }}.</h1>
                            </td>
                        </tr>
                    </table>
                    <!--[if (gte mso 9)|(IE)]>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                                ...
                                <p style="margin: 0;">Hi {{ $name }} ,Your Password successfully updated. Please check your Password was updated,Thank you.</p>
                            </td>
                        </tr>
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                                style="padding: 20px 30px 10px 30px; color: #666666; font-family: &apos;Lato&apos;, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                                <label>New updated Password : {{ $new_password }}</label>
