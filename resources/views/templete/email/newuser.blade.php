<DOCTYPE html>
    ...
    <body style="background-color: #f3f5f7; margin: 0 !important; padding: 0 !important;">
        ...
        <div
            ...
            Welcome on {{ config('app.name', 'Laravel') }}, We Will be in tuch, Please check your login
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        <tr>
                            <td bgcolor="#ffffff" align="center" valign="top"
                                ...
                                <h1 style="font-size: 42px; font-weight: 400; margin: 0;"> Welcome on
                                    {{ config('app.name', 'Laravel') }}, We Will be in tuch!</h1>
                            </td>
                        </tr>
                    </table>
                    <!--[if (gte mso 9)|(IE)]>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                                ...
                                <p style="margin: 0;">Hi {{ $name }} ,Please check your login information,Thank
                                    you.</p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td bgcolor="#ffffff" align="left"
                                style="padding: 20px 30px 10px 30px; color: #666666; font-family: &apos;Lato&apos;, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                                <label>Phone Number : {{ $phone_number }}</label>
                        ...
                        @if ($created_by)
                            <tr>
                                <td bgcolor="#ffffff" align="left"
                                    style="padding: 20px 30px 10px 30px; color: #666666; font-family: &apos;Lato&apos;, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 25px;">
                                    <label>Referred : {{ $created_by }}</label>
