        ...
        <div class="col-md-12 col-xl-12">
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    ...
                    alt="@if ($user) {{ $user->fname . ' ' . $user->lname }} @endif"  class="img-fluid rounded-circle mb-2" width="128"
                        height="128" />
                    @else
                    <img  src="{{ asset('assets/profile/user.jpg') }}" alt="@if ($user) {{ $user->fname . ' ' . $user->lname }} @endif"  class="img-fluid rounded-circle mb-2" width="128"
                        height="128" />
                    @endif
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li class="mb-1"><span class="fab fa-facebook fa-fw me-1"></span> <a href="#">Facebook</a>
                        </li>
            ...
            <div class="card">
                ...
                <div class="card-body h-100">
                    ...
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin/img/avatars/avatar-5.jpg')}}" width="36" height="36" class="rounded-circle me-2"
                            alt="Ashley Briggs">
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin/img/avatars/avatar.jpg')}}" width="36" height="36" class="rounded-circle me-2"
                            alt="Chris Wood">
                        <div class="flex-grow-1">
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin/img/avatars/avatar-4.jpg')}}" width="36" height="36" class="rounded-circle me-2"
                            alt="Stacie Hall">
                        <div class="flex-grow-1">
                    ...
                    <hr />
                    <div class="d-flex align-items-start">
                        <img src="{{ asset('admin/img/avatars/avatar-2.jpg')}}" width="36" height="36" class="rounded-circle me-2"
                            alt="Carl Jenkins">
                        <div class="flex-grow-1">
...
@push('css')
    <link rel="stylesheet" href="{{ url('/assets1/plugins/bootstrapvalidator-0.5.2/css/bootstrapValidator.min.css') }}" />
