...
@section('content')
    <div class="container-flude" id="chat-div" style="display: none;">
        <div class="row ">
            <div class="col-lg-12">
                        ...
                        <div class="col-12 col-lg-12 col-xl-12">
                            <div class="py-2 px-4 border-bottom d-none d-lg-block">
                                <div class="d-flex align-items-start align-items-center py-1">
                                    ...
                                    <div class="flex-grow-1 ps-3">
                                        ...
                                        <div class="text-muted small" id="to_user_online3"><em id="to_user_online2">Active
                                                Now</em></div>
                                    </div>
                            ...
                            <div class="flex-grow-0 py-3 px-4 border-top">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="text_total_count" id="text_total_count" value="0" />
                                    <input type="text" id="text_message" class="form-control"
                                        placeholder="Type your message" />
                                    <div id="text_message_error" class="invalid-feedback" style="display: none;">
    ...
    <div class="container-flude" id="balnk-div">
        <div class="row">
            <div class="col col-lg-9 mx-auto">

                <div id="blank-alert" style="display:none;" class="alert alert-primary alert-outline alert-dismissible"
                    role="alert">
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    <div class="alert-message">
                        <h4 class="alert-heading">No Messages!</h4>
                        <p>Messages are not available for you after <b>30 seconds</b> if messages for you then system
                            will provide you new messages.</p>
                        <hr>
                        <div class="btn-list">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-hidden="true" style="display: none;">
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
    @include('apimessage.js.singlechat')
