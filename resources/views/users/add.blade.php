...
@push('breadcrumb')
<h1 class="h3 mb-3">@if ($user) Edit User @else Create User @endif</h1>
    <!--breadcrumb-->
                ...
                <div class="card-body p-5">
                    ...
                    <form class="row g-3 needs-validation" id="create_user" method="POST"
                        ...
                        @if (Auth::user()->user_type == 'user')
                            <input type="hidden" name="user_type" value="subuser" />
                        @endif

                        @if (Auth::user()->user_type == 'admin' || Auth::user()->user_type == 'main' || Auth::user()->user_type == 'owner')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#inputEmail").blur(function() {
                ...
                var url = '';
                @if (isset($user))
                    url = "{{ route('user.checkemail') }}/{{ $user->id }}"
                @else
